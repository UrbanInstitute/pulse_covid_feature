...
aws s3 cp data/final-data/rolling_all_to_current_week.csv s3://${bucket_name}/rolling_all_current_week.csv
aws s3 cp data/intermediate-data/pulse_appended_columns_data_dictionary.csv s3://${bucket_name}/appended_column_data_dictionary.csv